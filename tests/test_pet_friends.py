...
def test_add_pets_with_valid_data(name='Wolf', animal_type='Chao-Chao', age='10', pet_photo='images/dog.jpeg'):
...
def test_delete_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pets(api_key, 'Wolf', 'Chao-Chao', '10', 'images/dog.jpeg')
        _, my_pets = pf.get_list_of_pets(api_key, 'my_pets')
...
def test_add_photo_at_pet(pet_photo='images/cat.jpeg'):
...
def test_add_pet_negative_age_number(name='Wolf', animal_type='Chao-Chao', age='-10', pet_photo='images/dog.jpeg'):
...
def test_add_pet_with_four_digit_age_number(name='Wolf', animal_type='Chao-Chao', age='12345', pet_photo='images/dog.jpeg'):
...
def test_add_pet_with_empty_value_in_variable_name(name='', animal_type='Chao-Chao', age='10', pet_photo='images/dog.jpeg'):
...
def test_add_pet_with_a_lot_of_words_in_variable_name(animal_type='Chao-Chao', age='10', pet_photo='images/dog.jpeg'):
...
def test_add_pet_with_special_characters_in_variable_animal_type(name='Wolf', age='10', pet_photo='images/dog.jpeg'):
...
def test_add_pet_with_numbers_in_variable_animal_type(name="Wolf", animal_type='34562', age='10',
...
def test_add_pet_with_a_lot_of_words_in_variable_animal_type(name='Wolf', age='10', pet_photo='images/dog.jpeg'):
